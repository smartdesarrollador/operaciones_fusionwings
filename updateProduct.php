                ...
                <form id="formUpdate" class="col s12" action="https://fusionwings.pe/script/updateProduct.php" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col l12 s12 m12 xl12">
                            <a href="<?= $ir ?>" class="btn-flat btn-large waves-effect waves-light  black-text" style="float: left" title="Volver">
                                <i class="material-icons">
                                    arrow_back
                                </i>
                            </a>

                            <a href="script/archivarAction.php?id=<?php echo $producto['idProducto'] ?>&status=1" onclick="return confirm('¿Esta Seguro de archivar el producto?');" class="btn-flat btn-large waves-effect waves-light  black-text" style="float: right" title="Archivar">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input value="<?php echo $producto['nombreProducto']; ?>" required id="first_name" type="text" class="validate" name="nombreProducto">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="textarea2" class="materialize-textarea validate" data-length="255" name="descripcionProducto"><?php echo $producto['descripcionProducto']; ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 l6 xl6 m6">
                            <?php if ($producto['store_id'] == 1) { ?>
                                <input value="<?php echo $producto['precioProducto']; ?>" name="precioProducto" onkeypress="return solonumeros()" required id="precio" type="text" class="validate">
                            <?php } ?>
                        ...
                        <div class="input-field col s12 l6 xl12 m12">
                            <input value="<?php echo $producto['acumulaNPuntos']; ?>" name="puntosProducto" onkeypress="return solonumeros()" required id="" type="number" class="validate">
                            <label for="precio">Puntos a acumular</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 l6 xl6 m6">
                            <select required class="validate" name="storeId">
                                <option <?= ($producto['store_id'] == '1') ? 'selected' : '' ?> value="1">Tienda Lince</option>
                                <option <?= ($producto['store_id'] == '2') ? 'selected' : '' ?> value="2">Tienda Surco</option>
                                <option <?= ($producto['store_id'] == '3') ? 'selected' : '' ?> value="1">Tienda Jesús María</option>
                            </select>
                            <label>Tipo Producto</label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col l12 xl12 m12 s12">
                            <button name="action" value="submit" type="submit" style="margin: 8px; width: 100%" class="btn btn-large waves-effect waves-light"><i class="material-icons right">
                                    loop
                                </i>Guardar
                            </button>
                        </div>
