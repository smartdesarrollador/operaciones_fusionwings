                ...
                <form class="col s12" action="https://fusionwings.pe/script/addProduct.php" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input data-min-height="410" data-max-file-size="2M" data-min-width="410" required data-allowed-file-extensions="jpg" type="file" class="dropify" id="fotoSubir" data-height="300" name="foto" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 l6 xl6 m6">
                            <input name="precioProducto" onkeypress="return solonumeros()" required id="precio" type="text" class="validate">
                            <label for="precio">Precio</label>
                        </div>
                        <div class="input-field col s12 l6 xl12 m12">
                            <input value="0" name="puntosProducto" min="0" onkeypress="return solonumeros()" required type="number" class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s12 l6 xl6 m6">
                            <select required class="validate" name="storeId">
                                <option value="" disabled selected>Elige una opción</option>
                                <option value="1">Tienda Lince</option>
                                <option value="2">Tienda Surco</option>
                                <option value="3">Tienda Jesús María</option>
                            </select>
                            <label>Tipo Producto</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col l6 xl6 m6 s12">
                            <a href="<?= $ir ?>" style="margin: 8px" class="btn btn-large red waves-effect waves-light"><i class="material-icons left">
                                    arrow_back
                                </i>Volver</a>
                        </div>
                        <div class="col l6 xl6 m6 s12">
                            <button name="action" value="submit" type="submit" style="margin: 8px" class="btn btn-large waves-effect waves-light"><i class="material-icons right">
                                    add_circle_outline
                                </i>Insertar
                            </button>
                        </div>
