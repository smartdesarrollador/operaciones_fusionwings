...
class Clientes
{
    ...
    public function getComprasxClienteLince()
    {
        try {
            $sql = "select nombre, apellido,email, SUM(precioTotal) as total from clientes INNER JOIN pedidos 
            on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 1 group by pedidos.idCliente";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
    ...
    public function getPuntosClientesLince()
    {
        try {
            $sql = "select DISTINCT nombre,apellido, email,puntos from clientes INNER JOIN pedidos on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 1";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
    ...
    public function getComprasxClienteSurco()
    {
        try {
            $sql = "select nombre, apellido,email, SUM(precioTotal) as total from clientes INNER JOIN pedidos 
            on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 2 group by pedidos.idCliente";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
    ...
    public function getPuntosClientesSurco()
    {
        try {
            $sql = "select DISTINCT nombre,apellido, email,puntos from clientes INNER JOIN pedidos on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 2";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
    ...
    public function getComprasxClienteJesusMaria()
    {
        try {
            $sql = "select nombre, apellido,email, SUM(precioTotal) as total from clientes INNER JOIN pedidos 
            on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 3 group by pedidos.idCliente";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
    ...
    public function getPuntosClientesJesusMaria()
    {
        try {
            $sql = "select DISTINCT nombre,apellido, email,puntos from clientes INNER JOIN pedidos on clientes.idCliente = pedidos.idCliente where pedidos.idTienda = 3";
            $lista = AccesoBD::Consultar($this->cn, $sql);
            return $lista;
        } catch (Exception $e) {
            $mensaje = "Fecha: " . date("Y-m-d H:i:s") . "\n" .
